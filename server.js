...
1. The CRA section above is provided for your reference - DO NOT include it in your response:
   - The CRA assessment will be automatically prepended to your summary
   - Focus ONLY on the underwriter summary sections below
   - DO NOT repeat or summarize the CRA section
...
Format clearly with warnings (⚠️) for rule violations.`;
    ...
    // Prepend the full CRA summary to ensure it's always included with all details
    const fullSummary = `${craSummary}
...
${underwriterSummary}`;
    ...
    res.json({
      ...
      underwriterSummary: fullSummary
    });
